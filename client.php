            ...
            <div class="col-md-5">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title"><i class="material-icons">person_add</i> Register Client</h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="licenseno" required="true">
                        </div>
                      </div>
                    </div>
                    <br>
                    <button type="submit" class="btn btn-primary btn-round pull-right">Register</button>
